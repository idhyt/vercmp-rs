...
static inline int rislower(int c) { return (c >= 'a' && c <= 'z'); }

/** \ingroup rpmstring
 * Locale insensitive isupper(3)
 */
static inline int risupper(int c) { return (c >= 'A' && c <= 'Z'); }

/** \ingroup rpmstring
 * Locale insensitive isalpha(3)
 */
static inline int risalpha(int c) { return (rislower(c) || risupper(c)); }

/** \ingroup rpmstring
 * Locale insensitive isdigit(3)
 */
static inline int risdigit(int c) { return (c >= '0' && c <= '9'); }

/** \ingroup rpmstring
 * Locale insensitive isalnum(3)
 */
static inline int risalnum(int c) { return (risalpha(c) || risdigit(c)); }

/** \ingroup rpmstring
 * Locale insensitive isblank(3)
 */
static inline int risblank(int c) { return (c == ' ' || c == '\t'); }
